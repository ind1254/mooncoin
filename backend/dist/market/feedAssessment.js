...
export function assessLiveFeedToken(token, nowMs, policy, duplicateSymbolCount) {
    ...
    let marketScore = liquidity === null
        ? 0
        : liquidity >= 5000000n * 1000000n
            ? 12
            : liquidity >= 1000000n * 1000000n
                ? 11
    ...
    marketScore += marketCap === null
        ? 0
        : marketCap >= 50000000n * 1000000n
            ? 5
            : marketCap >= 10000000n * 1000000n
                ? 4
                : marketCap >= 1000000n * 1000000n
                    ? 3
    ...
    if (liquidity !== null && marketCap !== null && marketCap > 0n) {
        depthBps = (liquidity * 10000n) / marketCap;
        marketScore += depthBps >= 1000n ? 3 : depthBps >= 400n ? 2 : depthBps >= 200n ? 1 : 0;
    }
    ...
    let momentumScore = fiveMinuteVolume >= 500000n * 1000000n
        ? 10
        : fiveMinuteVolume >= 100000n * 1000000n
            ? 9
                ...
                : traders >= 200
                    ...
                    : traders >= 75
                        ...
                        : traders >= 20
                            ? 1
                            : 0;
    let buyShareBps = null;
    if (buyVolume !== null || sellVolume !== null) {
        const total = (buyVolume ?? 0n) + (sellVolume ?? 0n);
        if (total > 0n) {
            buyShareBps = ((buyVolume ?? 0n) * 10000n) / total;
            momentumScore += buyShareBps >= 6000n ? 5 : buyShareBps >= 5200n ? 4 : buyShareBps >= 4500n ? 2 : 0;
            if (buyShareBps < 3500n) {
                risk += 10;
    ...
    if (change5m !== null) {
        momentumScore += change5m >= 100n && change5m <= 1500n
            ? 5
            : change5m > 10n && change5m < 100n
                ? 4
                : change5m >= -200n && change5m <= 10n
                    ? 2
                    : change5m > 1500n && change5m <= 4000n
                        ? 3
                        : change5m > 4000n
                            ? 1
                            : 0;
    ...
    momentumScore += twentyFourHourVolume >= 10000000n * 1000000n
        ? 2
        : twentyFourHourVolume >= 1000000n * 1000000n
            ? 1
            : 0;
    ...
    if (liquidityChange !== null && liquidityChange <= -1000n) {
        risk += 20;
    ...
    const quality = Math.max(0, Math.min(100, marketScore + momentumScore + safetyScore + maturityScore + confidencePillar - riskPenalty));
    ...
    const autoWatchEligible = status === "active" &&
        quality >= 85 &&
        risk <= 25 &&
        confidenceScore >= 75 &&
        ageMs !== null &&
        ageMs >= 15 * 60_000 &&
        marketCap !== null;
    const autoPaperEligible = autoWatchEligible &&
        quality >= 90 &&
        risk <= 15 &&
        ageMs >= 86_400_000 &&
        marketCap >= 250000n * 1000000n;
