import type { CalculationInput, WarningCode } from "./types.js";
...
export const REJECTION_CODES: ReadonlySet<WarningCode> = new Set([
  "STALE_QUOTE",
  "TOKEN_MISMATCH",
  "SAME_VENUE",
  "INCOMPLETE_DATA",
...
export function evaluateRisk(input: CalculationInput, netProfitMicroUsd: bigint): WarningCode[] {
