...
- **461 declared test cases** across 43 suites, all passing; strict-mode TypeScript
- **46 HTTP routes** (market, auth, live/demo paper trading, settings, bot, legacy/admin)
