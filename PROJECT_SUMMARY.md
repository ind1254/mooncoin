...
- **376 declared test cases** across 36 suites, all passing; strict-mode TypeScript
- **43 HTTP routes** (market, auth, live/demo paper trading, settings, bot, legacy/admin)
- **12 forward-only Postgres migrations**, shared by production and local tests
- **65 backend TypeScript source files**
<!-- METRICS:END -->
