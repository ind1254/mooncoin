...
- **362 declared test cases** across 34 suites, all passing; strict-mode TypeScript
- **42 HTTP routes** (market, auth, live/demo paper trading, settings, bot, legacy/admin)
- **11 forward-only Postgres migrations**, shared by production and local tests
- **64 backend TypeScript source files**
<!-- METRICS:END -->
